...
function CameraRig() {
  ...
  return useFrame((state) => {
    // زيادة زاوية الدوران بناءً على الوقت
    rotationAngle += 0.001 * Math.PI;

    // تحديث موضع الكاميرا باستخدام زاوية الدوران
    state.camera.position.set(
      10 * Math.sin(rotationAngle),
      0,
      10 * Math.cos(rotationAngle)
    );

    // تحديث اتجاه الكاميرا لتوجيهها نحو الأصل
